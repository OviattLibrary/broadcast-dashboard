 ...
 */
 jQuery(function ($) {
	$(document).ready(function() {
		...
		var hidden_text = document.getElementsByName('broadcast_dashboard_settings_update_msg_msg_text_' + id);
		...
		selector.onchange = function(){
			id = selector.value;
			hidden_text = document.getElementsByName('broadcast_dashboard_settings_update_msg_msg_text_' + id);
			bd_text_field.value = hidden_text.value;
		}
	});
});